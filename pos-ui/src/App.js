      ...
      <BrowserRouter>
        <Routes>
          ...
          <Route path="/home" element={<Home1 />}>
            ...
            <Route
              path="/home/contact/customer-group"
            ...
            <Route
              path="/home/purchase/create"
              element={<AddorEditPurchase />}
            />
            <Route
              path="/home/purchase/edit/:id"
              element={<AddorEditPurchase />}
            />
            ...
            <Route
              path="/home/purchase-order/create"
              element={<AddorEditPurchaseOrder />}
            />
            <Route
              path="/home/purchase-order/eidt/:id"
              element={<AddorEditPurchaseOrder />}
            />
            <Route path="/home/purchase-return" element={<PurchaseReturn />} />
            <Route
              path="/home/purchase-return/create"
              element={<AddorEditPucReturn />}
            />
            <Route
              path="/home/purchase-return/edit/:id"
              element={<AddorEditPucReturn />}
            />
            <Route path="/home/products" element={<Product />} />
            <Route
              path="/home/update-product-price"
              element={<UpdatePrice />}
            />
            <Route path="/home/import-products" element={<ImportProducts />} />
            <Route
              path="/home/import-opening-stock"
            ...
            <Route
              path="/home/selling-price-group"
              element={<SellingPriceGrp />}
            />
            ...
            <Route
              path="/home/products/add-selling-prices/:id"
              element={<AddorEditSellingPriceGrps />}
            />
            <Route
              path="/home/opening-stock/add/:id"
            ...
            <Route
              path="/home/stock-transfers"
              element={<ListStockTransfer />}
            />
            <Route
              path="/home/stock-transfers/create"
              element={<AddStockTransfer />}
            />
            <Route
              path="/home/sells/:type/edit/:id"
              element={<AddorEditSell />}
            />
          </Route>
        </Routes>
      </BrowserRouter>

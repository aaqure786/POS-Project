...
import { FaFilter, FaMapMarker, FaUser } from 'react-icons/fa'
import { BiChevronDown } from 'react-icons/bi';
import { format } from 'date-fns';
import { addDays } from 'date-fns';
import { DefinedRange } from 'react-date-range';
import PurchasePaymentTbl from '../reportTables/PurchasePaymentTbl';


const PurchasePaymentRpt = () => {
    const dummyData = [
        {
            id: 1,
            Username: "username",
    ...
    return (
        <div>
            <div className='flex flex-col  bg-gray-100 px-3 pb-3 min-h-screen'>
                <div className=' flex '>
                    <h1 className='font-bold text-xl text-start'>Purchase Payment Report</h1>
...
export default PurchasePaymentRpt
...
import ExpenseTbl from '../reportTables/ExpenseTbl';
import ExpenseChart from '../reportTables/ExpenseChart';
    ...
    return (
        <div>
            <div className='flex flex-col  bg-gray-100 px-3 pb-3 min-h-screen'>
                <div className=' flex '>
                    <h1 className='font-bold text-xl text-start'>Expense Report</h1>
                </div>
                        ...
                        <div className=' grid grid-cols-1 bg-white rounded-md gap-5 md:grid-cols-3 mt-5 w-full'>
                            ...
                            <div className='flex flex-col'>
                                ...
                                <div className='flex items-end justify-end mt-5'>
                                    <div className='flex bg-blue-500 text-white cursor-pointer px-2 py-1' >
                                        <h1 className='text-sm mx-1'>Apply Filter</h1>
                                    </div>
                                </div>
                            </div>

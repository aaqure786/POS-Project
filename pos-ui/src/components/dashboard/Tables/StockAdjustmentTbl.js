            ...
            {record.map((value, index) => {
              return (
                <tr key={index} className="">
                  ...
                  {col2 && <td className="px-1 py-1 text-sm">{value.date}</td>}
                  {col3 && <td className="px-1 py-1"> {value.id}</td>}
                  {col4 && <td className="px-1 py-1">{value.Location}</td>}
                  {col5 && (

...
const DocTable = () => {
    ...
    return (
        <div>
            ...
            {isClike &&
                <div className='absolute top-0 flex  justify-center right-0 bg-black/70 w-full min-h-screen'>
                    <div className='w-full md:w-[70%] min-h-screen my-10 bg-white p-5'>
                        <div className='w-full flex justify-between'>
                            <h1 className=' text-xl font-bold'>Add Notes</h1>
                            <MdCancel onClick={()=>{setIsClike(!isClike)}} size={20} />
                        </div>

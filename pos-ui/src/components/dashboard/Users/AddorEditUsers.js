...
const AddorEditUsers = () => {
    ...
    const handleClick = () => {
        if (userData.firstName.length === 0 ||
            ...
            userData.confrimPassword.length === 0 ||
    ...
    return (
        ...
        <div className='flex flex-col   py-5 bg-gray-200 min-h-screen' >
            <form>
            <h1 className='text-2xl items-start flex mx-6 justify-start  font-semibold'>{id ? "Edit User" : "Add User"}</h1>
            {/* Add User */}
            <div className='grid grid-cols-1 md:grid-cols-3 gap-10 mt-3 w-[96%] mx-[2%] bg-white shadow-sm p-5 shadow-gray-400'>
                ...
                <div className='flex flex-col items-start w-full'>
                    ...
                    <input value={userData.email} onChange={(e) => setUserData({ ...userData, email: e.target.value })} type='email' placeholder='Mr / Mrs / Miss' className='focus:outline-none w-full border-[1px] border-gray-300 px-2  rounded-sm p-1' />
                </div>
            ...
            <div className='flex flex-col mt-5 w-[96%] mx-[2%] bg-white shadow-sm p-5 shadow-gray-400'>
                ...
                <div className='flex  items-start mt-8'>
                    <input value={userData.isAllowLogin} onChange={(e) => setUserData({ ...userData, isAllowLogin: e.target.value })} type='checkbox' className='focus:outline-none rounded-md mt-1 w-5 h-5' />
                ...
                <div className='grid grid-cols-1 md:grid-cols-3 gap-10 mt-5 '>
                    ...
                    <div className='flex flex-col items-start w-full'>
                        <h1 className='text-lg flex'>Confirm Password:* <span className='text-red-500 mx-2 mt-1 text-sm'> {iserror && userData.confrimPassword.length ===0 ? "Required Field":""}</span></h1>
                        <input value={userData.confrimPassword} onChange={(e) => setUserData({ ...userData, confrimPassword: e.target.value })} type='password' placeholder='Confirm Password' className='focus:outline-none w-full border-[1px] border-gray-300 px-2  rounded-sm p-1' />
                    </div>
                ...
                <div className='flex items-start w-full mt-5'>
                    ...
                    <div className='flex flex-col mx-5'>
                        <div className='flex  items-start '>
                            <input name='aceessLocation' value={userData.aceessLocation} onChange={(e) => setUserData({ ...userData, aceessLocation: e.target.value })} type='checkbox' className='focus:outline-none rounded-md mt-1 w-5 h-5' />
            ...
            <div className='flex flex-col mt-5 w-[96%] mx-[2%] bg-white my-5 shadow-sm p-5 shadow-gray-400'>
                ...
                <div className='grid grid-cols-1  md:grid-cols-4 gap-5'>
                    ...
                    <div className='flex flex-col items-start w-full '>
                        ...
                        <select value={userData.martialStatus} onChange={(e) => setUserData({ ...userData, martialStatus: e.target.value })} type='text' className='focus:outline-none w-full border-[1px] border-gray-300 px-2  rounded-sm p-1' >
                            <option value={""}>-- Please Select --</option>
                    ...
                    <div className='grid grid-cols-1  md:grid-cols-4 gap-5'>
                        <div className='flex flex-col items-start w-full '>
                            ...
                            <input value={userData.momobileNumber} onChange={(e) => setUserData({ ...userData, mobileNumber: e.target.value })} type='text' placeholder='Mobile Number' className='focus:outline-none w-full   border-[1px] border-gray-300 px-2  rounded-sm p-1' />
                        </div>
                        <div className='flex flex-col items-start w-full '>
                    ...
                    <div className='grid grid-cols-1  md:grid-cols-4 gap-5'>
                        <div className='flex flex-col col-span-2 items-start w-full '>
                            <h1 className='text-lg'>Permenent Address:</h1>
                            <textarea value={userData.permenentAddress} onChange={(e) => setUserData({ ...userData, permenentAddress: e.target.value })} rows={4} type='text' placeholder='Permenent Address' className='focus:outline-none w-full   border-[1px] border-gray-300 px-2  rounded-sm p-1' />
                        </div>
                        <div className='flex flex-col col-span-2 items-start w-full '>

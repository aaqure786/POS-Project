                    ...
                    <button onClick={() => { setColvis(!colvis) }} className='flex border-[1px] relative px-2 py-1 hover:bg-gray-400 border-gray-600 bg-gray-200 '>
                        ...
                        {colvis && <div className='absolute top-7 shadow-md shadow-gray-400 bg-white w-[150px]'>
                            <ul className='flex flex-col items-center px-1 justify-start'>
                                ...
                                <li className={` w-full py-[1px] text-start ${col3 ? "" : "bg-blue-600"} hover:bg-blue-400 `} onClick={() => { setCol3(!col3) }}>Expense Category</li>
                                ...
                                <li className={` w-full py-[1px] text-start ${col7 ? "" : "bg-blue-600"} hover:bg-blue-400 `} onClick={() => { setCol7(!col7) }}>Expense For</li>
                                <li className={` w-full py-[1px] text-start ${col8 ? "" : "bg-blue-600"} hover:bg-blue-400 `} onClick={() => { setCol8(!col8) }}>Expense note</li>
                ...
                <table id='usertbl' className="table-fixed w-full  mb-10   px-5 ">
                    <thead>
                        <tr className='h-[50px] bg-gray-100'>
                            ...
                            {col3 && <th className=" py-2 title-font w-[75px]  tracking-wider font-medium text-gray-900 text-sm">Expense Category</th>}
                            ...
                            {col7 && <th className=" py-2 title-font w-[75px]  tracking-wider font-medium text-gray-900 text-sm">Expense For</th>}
                            {col8 && <th className=" py-2 title-font w-[55px]  tracking-wider font-medium text-gray-900 text-sm">Expense Note</th>}

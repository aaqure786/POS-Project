                    ...
                    <button onClick={() => { setColvis(!colvis) }} className='flex border-[1px] relative px-2 py-1 hover:bg-gray-400 border-gray-600 bg-gray-200 '>
                        ...
                        {colvis && <div className='absolute top-7 shadow-md shadow-gray-400 bg-white w-[150px]'>
                            <ul className='flex flex-col text-start px-2 justify-start'>
                                <li className={` w-full py-[1px] ${col1 ? "" : "bg-blue-600"} hover:bg-blue-400 `} onClick={() => { setCol1(!col1) }}>Expense Categories</li>
                                <li className={` w-full py-[1px] ${col2 ? "" : "bg-blue-600"} hover:bg-blue-400 `} onClick={() => { setCol2(!col2) }}>Total</li>
                                </ul>
                        </div>}
                    </button>
                ...
                <table id='usertbl'  className="table-fixed w-full ">
                    <thead>
                        <tr className='h-[50px] bg-white text-sm px-1 text-center'>
                            {col1 && <th className=" py-2   border-l-[1px] border-r-[1px] border-gray-200  tracking-wider  text-gray-900 "> Expense Categories</th>}
                            {col2 && <th className=" py-2 title-font border-l-[1px] border-r-[1px] border-gray-200  tracking-wider font-medium text-gray-900 ">Total</th>}
                            </tr>
                    </thead>
                    <tbody >

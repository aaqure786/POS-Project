...
import ViewPayments from '../reports/ViewPayments';
// import { Link } from 'react-router-dom';


const SellPaymentTbl = () => {
    const dummyData = [
        {
            id: 1,
            Username: "username",
                    ...
                    <button onClick={() => { setColvis(!colvis) }} className='flex border-[1px] relative px-2 py-1 hover:bg-gray-400 border-gray-600 bg-gray-200 '>
                        ...
                        {colvis && <div className='absolute top-7 shadow-md shadow-gray-400 bg-white w-[150px]'>
                            <ul className='flex flex-col text-start px-2 justify-start'>
                                <li className={` w-full py-[1px] ${col1 ? "" : "bg-blue-600"} hover:bg-blue-400 `} onClick={() => { setCol1(!col1) }}> </li>
                                <li className={` w-full py-[1px] ${col2 ? "" : "bg-blue-600"} hover:bg-blue-400 `} onClick={() => { setCol2(!col2) }}>Reference No.</li>
                                <li className={` w-full py-[1px] ${col3 ? "" : "bg-blue-600"} hover:bg-blue-400 `} onClick={() => { setCol3(!col3) }}>Paid On</li>
                                <li className={` w-full py-[1px] ${col4 ? "" : "bg-blue-600"} hover:bg-blue-400 `} onClick={() => { setCol4(!col4) }}>Amount</li>
                                <li className={` w-full py-[1px] ${col5 ? "" : "bg-blue-600"} hover:bg-blue-400 `} onClick={() => { setCol5(!col5) }}>Customer</li>
                                <li className={` w-full py-[1px] ${col6 ? "" : "bg-blue-600"} hover:bg-blue-400 `} onClick={() => { setCol6(!col6) }}>Customer Group</li>
                                <li className={` w-full py-[1px] ${col7 ? "" : "bg-blue-600"} hover:bg-blue-400 `} onClick={() => { setCol7(!col7) }}>Payment Method</li>
                                <li className={` w-full py-[1px] ${col8 ? "" : "bg-blue-600"} hover:bg-blue-400 `} onClick={() => { setCol8(!col8) }}>Sell</li>
                                <li className={` w-full py-[1px] ${col9 ? "" : "bg-blue-600"} hover:bg-blue-400 `} onClick={() => { setCol9(!col9) }}>Action</li>
                            </ul>
                        </div>}
                    </button>
                ...
                <table id='usertbl'  className="table-fixed w-full ">
                    <thead>
                        <tr className='h-[50px] bg-white text-sm px-1 text-center'>
                            {col1 && <th className=" py-2 w-10  border-l-[1px] border-r-[1px] border-gray-200  tracking-wider  text-gray-900 "> </th>}
                            {col2 && <th className=" py-2 title-font border-l-[1px] border-r-[1px] border-gray-200  tracking-wider font-medium text-gray-900 ">Reference No.</th>}
                            {col3 && <th className=" py-2 title-font border-l-[1px] border-r-[1px] border-gray-200  tracking-wider font-medium text-gray-900 ">Paid On</th>}
                            {col4 && <th className=" py-2 title-font border-l-[1px] border-r-[1px] border-gray-200  tracking-wider font-medium text-gray-900 ">Amount</th>}
                            {col5 && <th className=" py-2 title-font border-l-[1px] border-r-[1px] border-gray-200   tracking-wider font-medium text-gray-900 ">Customer</th>}
                            {col6 && <th className=" py-2 title-font border-l-[1px] border-r-[1px] border-gray-200   tracking-wider font-medium text-gray-900 ">Customer Group</th>}
                            {col7 && <th className=" py-2 title-font border-l-[1px] border-r-[1px] border-gray-200  tracking-wider font-medium text-gray-900 ">Payment Method</th>}
                            {col8 && <th className=" py-2 title-font border-l-[1px] border-r-[1px] border-gray-200  tracking-wider font-medium text-gray-900 ">Sell</th>}
                            {col9 && <th className=" py-2 title-font border-l-[1px] border-r-[1px] border-gray-200   tracking-wider font-medium text-gray-900 ">Action</th>}
                        </tr>
                    </thead>
                    <tbody >
                        {record.map((value, index) => {
                            return <tr key={index} className='text-sm'>
                                {col1 && <td className=" py-1 px-1 w-full ">
                                    </td>}
                                ...
                                {col8 && <td className="px-1 py-1 text-sm">{value.Name}</td>}
                                
                                {col9 && <td className="px-1 py-1"> 
                                    <button onClick={()=>{setIsClicked(true); setIsView(true); setViewId(value.id)}} className='bg-blue-500 text-white text-xs p-1 rounded-md'>View</button>
                                </td>}
                    ...
                    <tr className='font-bold h-[50px] items-center bg-gray-400'>
                            <td colSpan={3} className='text-center border-l-[1px] border-r-[1px] border-white'>Total</td>
                            <td  className='text-center border-l-[1px] border-r-[1px] border-white'>Rs 0.00</td>
                            <td colSpan={5} className='text-center border-l-[1px] border-r-[1px] border-white'></td>

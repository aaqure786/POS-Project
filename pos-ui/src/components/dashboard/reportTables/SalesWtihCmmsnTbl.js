                ...
                <table id='usertbl' className="table-fixed w-full  mb-10   px-5 ">
                    <thead>
                        <tr className='h-[50px] bg-gray-100'>
                            ...
                            {col2 && <th className=" py-2 title-font w-[70px]  tracking-wider font-medium text-gray-900 text-sm">Invoice No</th>}
                            {col3 && <th className=" py-2 title-font w-[75px]  tracking-wider font-medium text-gray-900 text-sm">Customer</th>}
                            {col4 && <th className=" py-2 title-font w-[101px]  tracking-wider font-medium text-gray-900 text-sm">Location</th>}
                            {col5 && <th className=" py-2 title-font w-[57px]  tracking-wider font-medium text-gray-900 text-sm">Payment Status</th>}
                            {col6 && <th className=" py-2 title-font w-[79px]  tracking-wider font-medium text-gray-900 text-sm">Total Amount</th>}
                            {col7 && <th className=" py-2 title-font w-[75px]  tracking-wider font-medium text-gray-900 text-sm">Total Paid</th>}
                            {col8 && <th className=" py-2 title-font w-[55px]  tracking-wider font-medium text-gray-900 text-sm">Total Remaining</th>}
                        ...
                        {record.map((value, index) => {
                            return <tr key={index} className={`${(index + 1) % 2 === 0 ? "bg-gray-200" : ""}`}>
                                ...
                                {col5 && <td className=" py-1 px-1">
                                   <button onClick={()=>{setIsClicked(true); setIsView(true); setViewId(value.id)}} className='bg-green-500 text-white text-xs rounded-md p-1'>Paid</button> </td>}
...
export default SalesWtihCmmsnTbl
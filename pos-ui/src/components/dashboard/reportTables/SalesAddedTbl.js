...
const SalesAddedTbl = () => {
    ...
    return (
        <div>
            ...
            <div className='flex  flex-col md:flex-row  items-center w-full justify-center mt-3 md:justify-between mx-5'>

                <div className='flex items-center w-1/6 justify-center my-2 md:my-0'>
                ...
                <div className='flex items-center w-4/6  justify-center my-2 md:my-0'>
                    ...
                    <button onClick={() => { setColvis(!colvis) }} className='flex border-[1px] relative px-2 py-1 hover:bg-gray-400 border-gray-600 bg-gray-200 '>
                        ...
                        {colvis && <div className='absolute top-7 shadow-md shadow-gray-400 bg-white w-[150px]'>
                            <ul className='flex flex-col items-center px-1 justify-start'>
                                ...
                                <li className={` w-full py-[1px] text-start ${col2 ? "" : "bg-blue-600"} hover:bg-blue-400 `} onClick={() => { setCol2(!col2) }}>Invoice No</li>
                                <li className={` w-full py-[1px] text-start ${col3 ? "" : "bg-blue-600"} hover:bg-blue-400 `} onClick={() => { setCol3(!col3) }}>Customer</li>
                                <li className={` w-full py-[1px] text-start ${col4 ? "" : "bg-blue-600"} hover:bg-blue-400 `} onClick={() => { setCol4(!col4) }}>Location</li>
                                <li className={` w-full py-[1px] text-start ${col5 ? "" : "bg-blue-600"} hover:bg-blue-400 `} onClick={() => { setCol5(!col5) }}>Payment Status</li>
                                <li className={` w-full py-[1px] text-start ${col6 ? "" : "bg-blue-600"} hover:bg-blue-400 `} onClick={() => { setCol6(!col6) }}>Total Amount</li>
                                <li className={` w-full py-[1px] text-start ${col7 ? "" : "bg-blue-600"} hover:bg-blue-400 `} onClick={() => { setCol7(!col7) }}>Total Paid</li>
                                <li className={` w-full py-[1px] text-start ${col8 ? "" : "bg-blue-600"} hover:bg-blue-400 `} onClick={() => { setCol8(!col8) }}>Total Remaining</li>
                ...
                <div className='flex items-center justify-center  w-1/6 md:w-auto my-2 md:my-0 border-[1px] border-black'>
            ...
            <div className='flex flex-col  overflow-x-scroll w-full mt-5 mx-5' ref={printRef} >
                <table id='usertbl' className="table-auto w-full  mb-10   px-5 ">
                    <thead>
                        <tr className='h-[50px] bg-gray-100'>
                            {col1 && <th className=" py-2 title-font  tracking-wider font-medium text-gray-900 text-sm">Date</th>}
                            {col2 && <th className=" py-2 title-font  tracking-wider font-medium text-gray-900 text-sm">Invoice No</th>}
                            {col3 && <th className=" py-2 title-font  tracking-wider font-medium text-gray-900 text-sm">Customer</th>}
                            {col4 && <th className=" py-2 title-font   tracking-wider font-medium text-gray-900 text-sm">Location</th>}
                            {col5 && <th className=" py-2 title-font  tracking-wider font-medium text-gray-900 text-sm">Payment Status</th>}
                            {col6 && <th className=" py-2 title-font  tracking-wider font-medium text-gray-900 text-sm">Total Amount</th>}
                            {col7 && <th className=" py-2 title-font  tracking-wider font-medium text-gray-900 text-sm">Total Paid</th>}
                            {col8 && <th className=" py-2 title-font  tracking-wider font-medium text-gray-900 text-sm">Total Remaining</th>}
                    ...
                    <tbody >
                        {record.map((value, index) => {
                            return <tr key={index} className={`${(index + 1) % 2 === 0 ? "bg-gray-200" : ""}`}>
                                {col1 && <td className='py-1 flex '>{value.Username}</td>}
                                ...
                                {col5 && <td className=" py-1 px-1">
                                   <button onClick={()=>{setIsClicked(true); setIsView(true); setViewId(value.id)}} className='bg-green-500 text-white rounded-md text-xs p-1'>Paid</button> </td>}

                    ...
                    <div className='flex flex-col w-3/4'>
                        ...
                        {variationValues.map((values, index) => {
                            return <div key={index} className='flex  mt-2'>
                                ...
                                <input type='text' value={values.variation} onChange={(e) => hadleChange(e, index)} placeholder='Variation Name' className='w-3/4 border-[1px] px-1 py-1 border-gray-400 focus:outline-none' />

            ...
            <div className='grid gap-10 grid-cols-1 md:grid-cols-2 '>
                ...
                <div className=' flex flex-col mt-2'>
                    ...
                    <div className='flex'>
                        ...
                        <input value={formData.email} onChange={ (e)=>setFormData({...formData,  email: e.target.value})} className='px-3 py-1 focus:outline-none w-full' type='text'   placeholder={t('eml')}/>
